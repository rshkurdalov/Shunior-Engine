...
{
	ns.value += (uint64)24 * 60 * 60 * 1000 * 1000 * 1000;
	return ns;
}
...
{
	min.value += ns.value / ((uint64)1000 * 1000 * 1000 * 60);
	return min;
}
...
{
	h.value += ns.value / ((uint64)1000 * 1000 * 1000 * 60 * 60);
	return h;
}

hours &operator<<(hours &h, microseconds mcs)
{
	h.value += mcs.value / ((uint64)1000 * 1000 * 60 * 60);
	return h;
}
...
{
	d.value += ns.value / ((uint64)1000 * 1000 * 1000 * 60 * 60 * 24);
	return d;
}

days &operator<<(days &d, microseconds mcs)
{
	d.value += mcs.value / ((uint64)1000 * 1000 * 60 * 60 * 24);
	return d;
}
